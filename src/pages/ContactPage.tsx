        ...
        <div className="max-w-2xl mx-auto">
          ...
          {error && (
            <div className="mb-6 p-4 bg-red-900/20 border border-red-500 rounded-lg flex items-center">
              ...
              <div>
                <p className="text-red-300 font-medium">{t('contact.error.title')}</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="additional_notes" className="text-white font-medium">
                    {t('contact.notes')} <span className="text-gray-400 text-sm font-normal">(Optional)</span>
                  </Label>
                  <Textarea
                    id="additional_notes"
          ...
          <div className="mt-16 text-center">
            <h2 className="text-2xl font-bold mb-8">{t('contact.whatHappensNext.title')}</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="space-y-3">
                <div className="bg-[#2a2a2a] rounded-full w-12 h-12 flex items-center justify-center mx-auto">
                  <span className="text-white font-bold">1</span>
                </div>
                <h3 className="font-semibold">{t('contact.whatHappensNext.step1.title')}</h3>
                <p className="text-gray-400 text-sm">{t('contact.whatHappensNext.step1.description')}</p>
              </div>
              <div className="space-y-3">
                <div className="bg-[#2a2a2a] rounded-full w-12 h-12 flex items-center justify-center mx-auto">
                  <span className="text-white font-bold">2</span>
                </div>
                <h3 className="font-semibold">{t('contact.whatHappensNext.step2.title')}</h3>
                <p className="text-gray-400 text-sm">{t('contact.whatHappensNext.step2.description')}</p>
              </div>
              <div className="space-y-3">
                <div className="bg-[#2a2a2a] rounded-full w-12 h-12 flex items-center justify-center mx-auto">
                  <span className="text-white font-bold">3</span>
                </div>
                <h3 className="font-semibold">{t('contact.whatHappensNext.step3.title')}</h3>
                <p className="text-gray-400 text-sm">{t('contact.whatHappensNext.step3.description')}</p>
              </div>
            </div>
          </div>
        </div>
