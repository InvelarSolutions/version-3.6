...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white overflow-x-hidden">
      ...
      {/* Global Ring Pattern - Behind everything but over backgrounds - RAISED SLIGHTLY */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-[1]">
        ...
        {Array.from({ length: 30 }, (_, i) => {
          ...
          // Calculate fade based on distance from center and scroll position - RAISED SLIGHTLY
          ...
          // Calculate ring position relative to viewport - RAISED SLIGHTLY (15% from top)
          const ringCenterY = (screenDimensions.height * 0.15) - scrollY; // Changed from 0.07 to 0.15 (raised slightly)
          ...
          return (
            <div
              ...
              style={{
                ...
                left: '50%',
                top: '15%', // Changed from 7% to 15% (raised slightly)
